...
; Route 17
	...
	db 33,WEEZING,0
	db 33,GRIMER,VOLTORB,0
	db 29,WEEZING,VENOMOTH,0
	db 25,KOFFING,WEEZING,KOFFING,MAGNETON,WEEZING,0
; Route 14
...
BrunoData:
	db $FF,54,ONIX,55,HITMONCHAN,55,HITMONLEE,56,GOLEM,56,POLIWRATH,58,MACHAMP,0
BrockData:
...
KogaData:
	db $FF,38,KOFFING,40,MUK,38,VENOMOTH,43,WEEZING,0
BlaineData:
	db $FF,42,GROWLITHE,43,MAGMAR,42,RAPIDASH,47,ARCANINE,0
SabrinaData:
	db $FF,38,KADABRA,40,MR_MIME,38,KADABRA,43,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
...
LoreleiData:
	db $FF,54,DEWGONG,54,CLOYSTER,55,SLOWBRO,55,STARMIE,56,JYNX,56,LAPRAS,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
