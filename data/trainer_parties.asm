...
; Viridian Gym
	db $FF,44,RHYHORN,42,DUGTRIO,45,NIDOQUEEN,45,NIDOKING,50,RHYDON,0
RocketData:
; Mt. Moon B2F
...
BrunoData:
	db $FF,54,ONIX,55,HITMONCHAN,55,HITMONLEE,56,ONIX,58,MACHAMP,0
BrockData:
...
BlaineData:
	db $FF,42,MAGMAR,40,NINETALES,42,RAPIDASH,47,ARCANINE,0
SabrinaData:
...
LoreleiData:
	db $FF,54,DEWGONG,53,CLOYSTER,55,SLOWBRO,56,JYNX,56,LAPRAS,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
