...
BrunoData:
	db $FF,53,ONIX,55,HITMONCHAN,55,HITMONLEE,56,POLIWRATH,58,MACHAMP,56,GOLEM,0
BrockData:
...
LoreleiData:
	db $FF,54,DEWGONG,53,CLOYSTER,54,SLOWBRO,56,JYNX,56,LAPRAS,56,STARMIE,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,56,GENGAR,56,GOLBAT,55,HAUNTER,58,ARBOK,60,GENGAR,58,MUK,0
LanceData:
