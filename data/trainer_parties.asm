...
; Silph Co. 8F
	db 30,GRIMER,ELECTABUZZ,0
; Silph Co. 9F
	db 28,PORYGON,KOFFING,MAGNETON,0
; Silph Co. 10F
	db 29,MAGNEMITE,PORYGON,0
; Mansion 3F
...
GiovanniData:
; Rocket Hideout B4F
	db $FF,25,ONIX,27,RHYHORN,29,KANGASKHAN,0
; Silph Co. 11F
	db $FF,39,NIDORINO,37,KANGASKHAN,39,RHYHORN,43,NIDOQUEEN,0
; Viridian Gym
	db $FF,45,RHYHORN,42,DUGTRIO,47,NIDOQUEEN,47,NIDOKING,50,RHYDON,0
RocketData:
; Mt. Moon B2F
...
; Victory Road 3F
	db 43,VILEPLUME,BUTTERFREE,VICTREEBEL,0
...
MistyData:
	db $FF,18,STARYU,21,STARMIE,60,MUK,0
LtSurgeData:
	db $FF,21,VOLTORB,18,PIKACHU,24,RAICHU,60,MUK,0
ErikaData:
	db $FF,29,VICTREEBEL,24,TANGELA,29,VILEPLUME,60,GOLBAT,0
KogaData:
	db $FF,38,KOFFING,40,MUK,38,GOLBAT,43,WEEZING,60,MUK,0
BlaineData:
	db $FF,42,GROWLITHE,43,MAGMAR,42,RAPIDASH,47,ARCANINE,60,GOLBAT,0
SabrinaData:
	db $FF,38,KADABRA,40,MR_MIME,38,VENOMOTH,43,ALAKAZAM,60,MUK,0
GentlemanData:
; SS Anne 1F Rooms
...
; Pokémon Tower 2F
	db $FF,25,PIDGEOTTO,23,GROWLITHE,22,EXEGGCUTE,20,KADABRA,25,WARTORTLE,60,MUK,0
	db $FF,25,PIDGEOTTO,23,GYARADOS,22,GROWLITHE,20,KADABRA,25,IVYSAUR,60,GOLBAT,0
	db $FF,25,PIDGEOTTO,23,EXEGGCUTE,22,GYARADOS,20,KADABRA,25,CHARMELEON,60,MUK,0
; Silph Co. 7F
	db $FF,37,PIDGEOT,38,GROWLITHE,35,EXEGGCUTE,35,ALAKAZAM,40,BLASTOISE,60,MUK,0
	db $FF,37,PIDGEOT,38,GYARADOS,35,GROWLITHE,35,ALAKAZAM,40,VENUSAUR,60,MUK,0
	db $FF,37,PIDGEOT,38,EXEGGCUTE,35,GYARADOS,35,ALAKAZAM,40,CHARIZARD,60,MUK,0
; Route 22
...
Green3Data:
	db $FF,61,PIDGEOT,60,ALAKAZAM,62,RHYDON,65,ARCANINE,67,EXEGGUTOR,70,BLASTOISE,0
	db $FF,61,PIDGEOT,60,ALAKAZAM,62,RHYDON,65,GYARADOS,67,ARCANINE,70,VENUSAUR,0
	db $FF,61,PIDGEOT,60,ALAKAZAM,62,RHYDON,65,EXEGGUTOR,67,GYARADOS,70,CHARIZARD,0
LoreleiData:
	db $FF,54,DEWGONG,53,CLOYSTER,54,SLOWBRO,56,JYNX,60,MUK,56,LAPRAS,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,56,GENGAR,56,GOLBAT,55,HAUNTER,58,ARBOK,60,MUK,60,GENGAR,0
LanceData:
	db $FF,58,GYARADOS,56,DRAGONAIR,56,DRAGONAIR,60,AERODACTYL,60,CHARIZARD,62,DRAGONITE,0
