...
; Viridian Gym
	db $FF,45,RHYHORN,42,DUGTRIO,46,NIDOQUEEN,46,NIDOKING,50,RHYDON,0
RocketData:
; Mt. Moon B2F
...
BlaineData:
	db $FF,42,NINETALES,40,MAGMAR,42,RAPIDASH,47,ARCANINE,0
SabrinaData:
	db $FF,39,KADABRA,37,MR_MIME,39,KADABRA,43,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
