...
; Route 15
	db 28,WEEPINBELL,ODDISH,ODDISH,0
...
; Rock Tunnel B1F
	...
	db 25,SLOWPOKE,0
; Victory Road 2F
	db 40,PINSIR,LAPRAS,LICKITUNG,0
; Rock Tunnel 1F
...
KogaData:
	db $FF,38,KOFFING,37,MUK,38,VENOMOTH,43,WEEZING,0
BlaineData:
	db $FF,42,NINETALES,40,MAGMAR,42,RAPIDASH,47,ARCANINE,0
SabrinaData:
	db $FF,38,KADABRA,37,MR_MIME,38,KADABRA,43,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
...
LoreleiData:
	db $FF,54,DEWGONG,53,CLOYSTER,55,SLOWBRO,55,STARMIE,56,JYNX,56,LAPRAS,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,56,GENGAR,56,GOLBAT,55,HAUNTER,58,ARBOK,58,HAUNTER,60,GENGAR,0
LanceData:
	db $FF,58,GYARADOS,56,DRAGONAIR,58,DRAGONAIR,56,DRAGONAIR,60,AERODACTYL,62,DRAGONITE,0
